<template>
  <div class="login_container" v-title data-title="注册 — 星愿墙">
    ...
    <div
      class="login_box w-130 h-120 <md:w-120 <md:h-110 <sm:w-10/12 <sm:h-110"
    >
      <el-form
        ref="RegisterFromRef"
        :model="RegisterFrom"
          ...
          >
            ...
            >
              ...
              <Slider
                ...
                :status="rangeStatus"
                :img-url="rotateCodeUrl"
                @rotateAngle="(data) => (rotateAngle = parseInt(data))"
              ></Slider>
            </div>
            ...
            <el-button
              ...
              type="primary"
              class="w-full"
              v-if="showCountDownRotateCode === true"
            >
